...
const fetchDynamicSheetDataForAllowedUsers = async (req, res) => {
  const spreadsheetId = "1hbBBJbNijhM3M2JMZzshk_8EsXzdcns5X0wfqRu0uOE";
  const sheetTitle = AllSheetNames.DYNAMIC_MASTER_TABLEAllowedUsers;
...
module.exports = {
  ...
  fetchDynamicSheetDataForAllowedUsers
};
